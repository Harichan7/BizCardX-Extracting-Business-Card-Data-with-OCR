...
icon = Image.open(r"C:\Users\91701\Desktop\phonepay\ICON.jpg")
st.set_page_config(page_title="Bizcardx: Extracting Business card Data with OCR",
                   page_icon= icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About':"""# This OCR is crested by *Harish*!"""})
...
def setting_bg():
    st.markdown(f"""<style>.stApp{{
                      background:url(" https://cutewallpaper.org/27/black-wallpaper-geo/179703493.jpg");
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"], 
                       ...
                       styles={"nav-link": {"font-size": "35px", "text-align": "centre", "margin": "0px", "--hover-color": "#df5ef2"},
                               "icon": {"font-size": "35px"},
                               "container" : {"max-width": "6000px"},
                               "nav-link-selected": {"background-color": "#df5ef2"}})
